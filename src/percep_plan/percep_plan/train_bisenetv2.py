#!/usr/bin/env python3
"""
BiSeNetV2 Training Script
This script trains a BiSeNetV2 model for road segmentation using:
- Original images from train/valid/test folders
- Thresholded masks from thresh_train/thresh_valid/thresh_test folders
"""
